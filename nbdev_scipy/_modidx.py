...
d = { 'mods': [ 'scipy', 'scipy.cluster', 'scipy.fftpack', 'scipy.io', 'scipy.linalg', 'scipy.optimize', 'scipy.signal', 'scipy.sparse', 'scipy.spatial',
            'scipy.special', 'scipy.stats', 'scipy.cluster.hierarchy', 'scipy.integrate', 'scipy.interpolate', 'scipy.io.arff', 'scipy.odr',
            'scipy.sparse.linalg', 'scipy.spatial.transform', 'scipy.constants', 'scipy.io.wavfile', 'scipy.sparse.csgraph', 'scipy.cluster.vq', 'scipy.fft',
            'scipy.fftpack.convolve', 'scipy.linalg.blas', 'scipy.linalg.interpolative', 'scipy.linalg.lapack', 'scipy.misc', 'scipy.ndimage',
            'scipy.signal.windows', 'scipy.spatial.distance', 'scipy.stats.contingency', 'scipy.stats.mstats'],
  'syms': { 'scipy': { 'scipy.cluster': 'https://docs.scipy.org/doc/scipy/reference/cluster.html#module-scipy.cluster',
  ...
  'settings': {'lib_path': Path('nbdev_scipy')}}
